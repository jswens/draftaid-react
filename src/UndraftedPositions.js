...
function UndraftedPositions(props) {
  const fields = ["tier", "name", "team", "vs_adp", "bye_week", "notes"];
  ...
  return (
    <div className="col-md-6 col-sm-12 hidden-xs">
      ...
      <div className="col-sm-6">
        <span className="col-sm-12 position-title">Linebackers</span>
        <Undrafted
          fields={fields}
          players={props.players}
          draft={(p) => props.draft(p)}
      ...
      <div className="col-sm-6">
        <span className="col-sm-12 position-title">D-Line</span>
        <Undrafted
          fields={fields}
          players={props.players}
          draft={(p) => props.draft(p)}
      ...
      <div className="col-sm-6">
        <span className="col-sm-12 position-title">D-Backs</span>
        <Undrafted
          fields={fields}
          players={props.players}
          draft={(p) => props.draft(p)}
